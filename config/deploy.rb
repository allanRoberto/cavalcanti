...
set :application, "cavalcanti" #FIXME
...
set :scm, :git
set :repository,  "git@github.com:allanRoberto/cavalcanti.git" #FIXME
# set :scm, :subversion
...
set :local_path, "/Users/Allan/sites/cavalcanti" #FIXME
...
set :local_domain, 'cavalcanti.art.com.br' #FIXME
